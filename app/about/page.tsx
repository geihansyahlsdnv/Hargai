  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
        Prinsip yang mendasari setiap inovasi teknologi yang kami
        kembangkan.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
        ...
        <CardContent>
          <p className="text-gray-600 font-sans text-center">
            Menggunakan teknologi Computer Vision modern untuk membantu
            proses deteksi sampah secara cepat dan akurat.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
        ...
        <CardContent>
          <p className="text-gray-600 font-sans text-center">
            Membantu meningkatkan kesadaran pengelolaan sampah untuk
            mendukung lingkungan yang lebih bersih dan berkelanjutan.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
        ...
        <CardContent>
          <p className="text-gray-600 font-sans text-center">
            Menampilkan informasi klasifikasi dan estimasi harga secara
            jelas agar lebih mudah dipahami pengguna.
          </p>
        </CardContent>
      </Card>
    </div>
...
<section className="py-20 bg-gray-50">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
        Alur kerja cerdas yang mengubah gambar menjadi informasi yang
        bermanfaat.
      </p>
    </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 font-sans">
                Proses identifikasi jenis sampah secara otomatis melalui
                kamera maupun unggahan gambar.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 font-sans">
                Sistem menampilkan estimasi harga berdasarkan kategori
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 font-sans">
                ...
                memerlukan pemahaman teknis yang kompleks.
              </p>
            </div>
          </div>
        </div>
